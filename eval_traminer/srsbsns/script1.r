...
barplot(nat_count[which(nat_count[]>5000)],main="Nationalités")
...
barplot(nat_count[which(nat_count[]>1000)],main="Nationalités")

##=- Nach méi (komplett verfälscht, wiirklech JUST fir ze testen)
...
"digest non-infect","malad de la peau","inflamm ostéo-artic","degen ostéo-artic",
"génito-urin","ORL et dent","oeil et annex","malad circulation","respi non-infect",
"troubles mentaux","endocr-nutri-métabol","compl grossesse","cures therm","autre","travaillant")
...
## E puer Saachen:
seqiplot(smalldata.seq[1:500,],tlim=0,withlegend=F,border=NA,title="Quelques séquences")
seqdplot(smalldata.seq,border=NA,title="Densités")
