...
for i=1:size(T,1),
  ...
  line(N(T(i,1:2),1),N(T(i,1:2),2),'LineWidth',T(i,1+3)*3+1,'color','white');
  line(N(T(i,2:3),1),N(T(i,2:3),2),'LineWidth',T(i,2+3)*3+1,'color','white');
  line(N(T(i,[1 3]),1),N(T(i,[1 3]),2),'LineWidth',T(i,3+3)*3+1,'color','white');
end;
